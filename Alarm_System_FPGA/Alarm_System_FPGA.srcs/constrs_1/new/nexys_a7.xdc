## Clock signal from onboard 100 MHz oscillator
set_property PACKAGE_PIN E3 [get_ports clk]
set_property IOSTANDARD LVCMOS33 [get_ports clk]

## Create a 100 MHz clock for Vivado
...
set_property IOSTANDARD LVCMOS33 [get_ports {btnC btnU btnL btnR}]
...
set_property IOSTANDARD LVCMOS33 [get_ports {seg[*] dp an[*]}]

## Buzzer --- USING JB1
set_property PACKAGE_PIN D14 [get_ports buzzer]
